...
# API Key da empresa 3
API_KEY_EMPRESA_3 = os.getenv('API_KEY_03')
if not API_KEY_EMPRESA_3:
    raise ValueError("❌ API_KEY_03 não encontrada no .env!")
...
def executar_extracao_completa():
    ...
    TODOS os extractors recebem empresa_id=3
    """
...
def executar_transformacao_completa():
    ...
    TODOS os transformers recebem empresa_id=3
    """
    print(f"\n{'='*70}")
...
def executar_pipeline_completo():
    ...
    # Estatísticas do DW (apenas empresa 3)
    ...
    if sucesso_extracao == total_extracao and sucesso_transformacao == total_transformacao:
        ...
        print(f"   3. Para adicionar outras empresas, crie main_pipeline_4.py, etc.")
    else:
