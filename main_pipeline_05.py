# Responsável por: executar TODOS os extratores E transformadores em sequência em Empresa ID - 5
...
def executar_extracao_completa():
    ...
    TODOS os extractors recebem empresa_id=5
    """
...
def executar_transformacao_completa():
    ...
    TODOS os transformers recebem empresa_id=5
    """
    print(f"\n{'='*70}")
    ...
    try:
        ...
        print("\n📊 VERIFICANDO REGISTROS PENDENTES (EMPRESA 5)...")
        print("-" * 70)
...
def executar_pipeline_completo():
    ...
    VERSÃO MULTI-CNPJ para EMPRESA 5
    ...
    """
    print("\n" + "=" * 70)
    print("🔄 PIPELINE COMPLETO: EMPRESA 5")
    print("=" * 70)
    print(f"📌 Empresa ID: {EMPRESA_ID}")
    ...
    # Estatísticas do DW (apenas empresa 5)
    print(f"\n📈 ESTATÍSTICAS DO DATA WAREHOUSE (EMPRESA 5):")
    print("-" * 70)
    session = Session()
    try:
        # Contatos
    ...
    if sucesso_extracao == total_extracao and sucesso_transformacao == total_transformacao:
        ...
        print(f"\n💡 PRÓXIMOS PASSOS:")
        print(f"   1. DW sincronizado com a Bling (Empresa 5)")
        print(f"   2. Power BI pode ser atualizado")
        print(f"   3. Para adicionar outras empresas, crie main_pipeline_6.py")
    else:
