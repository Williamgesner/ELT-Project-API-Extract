...
# API Key da empresa 2
API_KEY_EMPRESA_2 = os.getenv('API_KEY_02')
if not API_KEY_EMPRESA_2:
    raise ValueError("❌ API_KEY_02 não encontrada no .env!")
...
def executar_extracao_completa():
    ...
    TODOS os extractors recebem empresa_id=2
    """
...
def executar_transformacao_completa():
    ...
    TODOS os transformers recebem empresa_id=2
    """
    print(f"\n{'='*70}")
...
def executar_pipeline_completo():
    ...
    VERSÃO MULTI-CNPJ para EMPRESA 2
    ...
    """
    print("\n" + "=" * 70)
    print("🔄 PIPELINE COMPLETO: EMPRESA 2")
    print("=" * 70)
    print(f"📌 Empresa ID: {EMPRESA_ID}")
    ...
    # Estatísticas do DW (apenas empresa 2)
    ...
    if sucesso_extracao == total_extracao and sucesso_transformacao == total_transformacao:
        ...
        print(f"   3. Para adicionar outras empresas, crie main_pipeline_3.py, etc.")
    else:
