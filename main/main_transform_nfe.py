...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Transformar NFe de raw para fato',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_transform_nfe
  
  # Processar apenas a empresa 01
  python3 -m main.main_transform_nfe --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_transform_nfe --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
