...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Transformar canais de raw para dimensão',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_transform_channels
  
  # Processar apenas a empresa 01
  python3 -m main.main_transform_channels --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_transform_channels --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
