...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Extrair contas a pagar do Bling',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_accounts_payable
  
  # Processar apenas a empresa 01
  python3 -m main.main_accounts_payable --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_accounts_payable --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
