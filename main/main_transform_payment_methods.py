...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Transformar formas de pagamento de raw para dimensão',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_transform_payment_methods
  
  # Processar apenas a empresa 01
  python3 -m main.main_transform_payment_methods --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_transform_payment_methods --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
    ...
    try:
        ...
        for empresa_config in empresas_para_processar:
            ...
            transformer = FormasPagamentoTransformer(empresa_id)
