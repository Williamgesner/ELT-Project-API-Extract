...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Extrair contatos completos do Bling',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_contacts
  
  # Processar apenas a empresa 01
  python3 -m main.main_contacts --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_contacts --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
