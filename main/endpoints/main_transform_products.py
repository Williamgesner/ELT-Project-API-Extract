...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Transformar produtos de raw para dimensão',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_transform_products
  
  # Processar apenas a empresa 01
  python3 -m main.main_transform_products --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_transform_products --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
