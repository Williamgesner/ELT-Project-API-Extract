...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Transformar vendas de raw para fato',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  # Processar todas as empresas
  python3 -m main.main_transform_sales
  
  # Processar apenas a empresa 01
  python3 -m main.main_transform_sales --empresa 1
  
  # Processar apenas a empresa 02
  python3 -m main.main_transform_sales --empresa 2
        """
    )
    parser.add_argument(
        '--empresa',
    ...
    try:
        ...
        for empresa_config in empresas_para_processar:
            ...
            transformer = VendasTransformer(empresa_id)
